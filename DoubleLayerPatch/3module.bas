...
With Brick
     ...
     .Xrange "size/2", "-size/2" 
     .Yrange "size/2", "-size/2" 
     .Zrange "layer1_Hight+layer2_Hight+layer3_Hight+layer4_Hight+layer5_Hight", "layer1_Hight+layer2_Hight+layer3_Hight+layer4_Hight+layer6_Hight" 
     .Create
End With
...
With Brick
     ...
     .Zrange "layer1_Hight+layer2_Hight+layer3_Hight+layer4_Hight+layer6_Hight", "layer1_Hight+layer2_Hight+layer3_Hight+layer4_Hight+layer6_Hight+layer7_Hight" 
     .Create
End With
...
With Brick
     ...
     .Xrange "size/2", "-size/2" 
     .Yrange "size/2", "-size/2" 
     .Zrange "layer1_Hight+layer2_Hight+layer3_Hight+layer4_Hight+layer6_Hight+layer7_Hight", "layer1_Hight+layer2_Hight+layer3_Hight+layer4_Hight+layer6_Hight+layer7_Hight+layer8_Hight" 
     .Create
End With
